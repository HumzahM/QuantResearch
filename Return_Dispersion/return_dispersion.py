...
# event_months, time_months, normalized_trading_scaled_rd = get_event_blocks_return_dispersion()
# event_months, time_months, normalized_trading_scaled_tm = get_event_month_blocks(2520)
# print(normalized_trading_scaled_rd)
# print(normalized_trading_scaled_tm)
# plt.figure()
# plt.plot(normalized_trading_scaled_rd, label="Return Dispersion")
# plt.plot(normalized_trading_scaled_tm, label="Total Market Trades")
# plt.legend()
# plt.ylabel("Normalized Trades per Day")
# plt.savefig("return dispersion vs total market trades.png")